...
function compressImage(file: File, maxWidth = 800, maxHeight = 800, quality = 0.85): Promise<Blob> {
...
export function IdentityTab({ clinic }: IdentityTabProps) {
  ...
  const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(`/api/clinics/${clinic.tenantId}/branding/logo`, {
        method: "POST",
        body: formData,
      });
